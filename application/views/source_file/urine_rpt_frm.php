...
?>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="<?php echo base_url(); ?>data_record/save_urine_re.html" method="post">
                ...
                <div class="form-group has-success">
                    ...
                    <div class="row">         
                        ...
                        <div class="col-xs-2">
                            <input type="text" name="material" id="hospital_name" class="form-control" value="<?php echo "Urine RE"; ?>">
                        </div> 
<?php
/*
 * 
                    ...
                    <div class="row">         
                        <div class="col-xs-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-1">
                                    <input type="text" name="quantity" class="form-control" value="<?php echo "20 ml"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    Color
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="color" class="form-control" value="<?php echo "Straw"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    Appearance
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="apper" class="form-control" value="<?php echo "Clear"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    Sediment
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="sediment" class="form-control" value="<?php echo "Nil"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    Spec.Grav.
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="spe_grav" class="form-control" value="<?php echo "QNS"; ?>">
                                </div> <br><br>
                                ...
                                <div class="col-xs-1">
                                    <input type="text" name="ex_ph" class="form-control" value="<?php echo "Acidic"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    Albumin
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="albumin" class="form-control" value="<?php echo "N/D"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    Sugar
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="sugur" class="form-control" value="<?php echo "N/D"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    Others	
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="others" class="form-control" value="<?php echo "N/D"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    Acetone
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="acetone" class="form-control" value="<?php echo "N/D"; ?>">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-xs-1">
                                    BileSalt</div>
                                <div class="col-xs-1">
                                    <input type="text" name="bile_salt" class="form-control" value="<?php echo "N/D"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    Bile pig.
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="bile_pig" class="form-control" value="<?php echo "N/D"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    Urobili
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="urobili" class="form-control" value="<?php echo "N/D"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    Chyle  </div>
                                <div class="col-xs-1">
                                    <input type="text" name="chyle" class="form-control" value="<?php echo "N/D"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    B.Jons Protein  </div>
                                <div class="col-xs-1">
                                    <input type="text" name="b_jons_protein" class="form-control" value="<?php echo "N/D"; ?>">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-1">
                                    <input type="text" name="ep_cell" class="form-control" value="<?php echo " /HPF"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    Pus Cells
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="pus_cells" class="form-control" value="<?php echo " /HPF"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    RBCs
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="rbcs" class="form-control" value="<?php echo "Nil"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    Mucus
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="mucus" class="form-control" value="<?php echo "Nil"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    Pus Cust
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="pus_cast" class="form-control" value="<?php echo "Nil"; ?>">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-xs-1">
                                    <input type="text" name="sperat" class="form-control" value="<?php echo "Nil"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    WBCcast
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="wbc" class="form-control" value="<?php echo "Nil"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    Granu.Cast
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="granuloar" class="form-control" value="<?php echo "Nil"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    Cal.Oxa.
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="cal_oxa" class="form-control" value="<?php echo "Nil"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    U.A.Cry
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="uric_acid" class="form-control" value="<?php echo "Nil"; ?>">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-xs-1">
                                    <input type="text" name="tre_phs" class="form-control" value="<?php echo "Nil"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    Sulph.Cry
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="sulph_cry" class="form-control" value="<?php echo "Nil"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    HaylineCast 
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="hayline_cast" class="form-control" value="<?php echo "Nil"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    Bacteria
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-1">
                                    <input type="text" name="amr_ph" class="form-control" value="<?php echo "Nil"; ?>">
                                </div>
                                <div class="col-xs-1">
                                    Urate Cry.
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" name="urate_crys" class="form-control" value="<?php echo "Nil"; ?>">
                                </div>
                                <br>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group has-success">
                    <br><br> 
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-hover tableradius" id="urine_rpt">
