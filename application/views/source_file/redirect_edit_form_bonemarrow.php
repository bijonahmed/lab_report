...
<br>
  ...
  <h3 class="fontcolor">{{test_id}}</h3>
                        <form name="employee" method="post" action="<?php echo base_url(); ?>welcome/SearchBoneMarrowInfo.html">
...
if ($CallBomeMarrowInfo != null) {
    ?>                
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-hover tableradius" id="example" style="background-color: yellowgreen; border-color: yellow; border-radius: 5px;" >
                        ...
                        <tbody>
    <?php
    foreach ($CallBomeMarrowInfo as $data) {
        ?>
...
<td><a class="red-tooltip link" data-toggle="tooltip" data-placement="bottom" 
       ...
       href="<?php echo redirect("data_record/edit_bonemarrow_rpt/$data->bone_maro_id"); ?>" onClick="return sure_();" style="text-decoration:none"><div class="glyphicon glyphicon-edit"></div>&nbsp;EDIT</a></td>
