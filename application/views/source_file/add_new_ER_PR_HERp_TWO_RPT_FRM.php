...
?>
            ...
            <form action="<?php echo base_url(); ?>data_record/save_her_two_info.html" method="post">
                <div class="form-group has-success">
                    <div class="row">
                        ...
                        <div class="col-xs-2">
                            <input type="text" name="test_id" class="form-control" placeholder="Test ID" ng-model="test_id" value="<?php echo "MIHC".date("y").":"; ?>">
                        </div>
                        <div class="col-xs-2">
                   ...
                   <strong>  PR </strong>
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-xs-10">
                            <textarea class="form-control" name="her_two_rpt" col="5"></textarea>
                        </div>
                        <div class="col-xs-2">
                            <br>
  ...
  <div class="row">         
                        <div class="col-xs-12">
                            <input type="text" name="kisixtyseven" class="form-control">
                        </div>
