...
<html lang="en" ng-app="">
    <head>
        ...
        <script>
            $(function () {
<?php
foreach ($SearchSingleLineID as $row):
    $SearchSingleLineID[] = $row->test_id;
endforeach;

echo "var javascript_array =" . json_encode($SearchSingleLineID);
?>
    ...
    <body ng-app="">
        ...
        <div class="container">
            ...
            <div align="right">
                <?php
                if ($CallSingleLineNameInfo != null) {
                    ?>   
                <br>
...
<br>
  ...
  <h3 class="fontcolor">{{test_id}}</h3>
                        <form name="employee" method="post" action="<?php echo base_url(); ?>welcome/SearchSingleLineNameInfo.html">
...
if ($CallSingleLineNameInfo != null) {
    ?>                
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-hover tableradius" id="example" style="background-color: yellowgreen; border-color: yellow; border-radius: 5px;" >
                        ...
                        <tbody>
    <?php
    foreach ($CallSingleLineNameInfo as $data) {
        ?>
...
<td><a class="red-tooltip link" data-toggle="tooltip" data-placement="bottom" 
       ...
       href="<?php echo redirect("data_record/edit_sineline_rpt/$data->immu_id"); ?>" onClick="return sure_();" style="text-decoration:none"><div class="glyphicon glyphicon-edit"></div>&nbsp;EDIT</a></td>
