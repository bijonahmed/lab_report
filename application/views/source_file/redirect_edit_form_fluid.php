...
<html lang="en" ng-app="">
    <head>
        ...
        <script>
            $(function () {
<?php
foreach ($SearchfluidID as $row):
    $SearchfluidID[] = $row->test_id;
endforeach;

echo "var javascript_array =" . json_encode($SearchfluidID);
?>
...
<br>
  ...
  <h3 class="fontcolor">{{test_id}}</h3>
                        <form name="employee" method="post" action="<?php echo base_url(); ?>welcome/SearchfluidNameInfo.html">
...
<td><a class="red-tooltip link" data-toggle="tooltip" data-placement="bottom" 
       title="" data-original-title="Edit Bone Marrow Report" 
       href="<?php echo redirect("data_record/edit_fluid_rpt/$data->ascitic_fluid_id"); ?>" onClick="return sure_();" style="text-decoration:none"><div class="glyphicon glyphicon-edit"></div>&nbsp;EDIT</a></td>
