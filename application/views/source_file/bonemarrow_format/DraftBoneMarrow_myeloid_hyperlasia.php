...
<table width="802" border="0">
  ...
  <tr>
    ...
    <td valign="top"><span class="style63"><strong>:</strong></span></td>
    <td valign="top" class="style63">Active and maturing into  segmented form. </td>
  </tr>
  <tr>
...
<table width="1002" border="0" cellpadding="1" cellspacing="0">
  <tr>
    <td width="646" valign="top" scope="row"><p class="style63"><strong>Erythropoiesis</strong> <strong>:</strong>Active  and normoblastic.<br />
              <strong>Megakaryopoiesis</strong> <strong>:</strong>Normal<br />
    </p>
        <p class="style56"><strong>Comment:&nbsp;Myeloid  hyperplasia .&nbsp; </strong><strong>&nbsp;</strong></p>
        <p></p></td>
    <td colspan="2">&nbsp;</td>
