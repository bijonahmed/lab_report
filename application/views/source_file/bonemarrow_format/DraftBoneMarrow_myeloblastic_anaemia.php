...
<table width="802" border="0">
  ...
  <tr>
    ...
    <td valign="top"><span class="style63"><strong>:</strong></span></td>
    <td valign="top" class="style63">Grossly  hypercellular.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td valign="top"><span class="style63"><strong>:</strong></span></td>
    <td valign="top" class="style63">Active &nbsp;and maturing into segmented form&nbsp; with few giant  metamyelocytes. </td>
  </tr>
  <tr>
...
<table width="1002" border="0" cellpadding="1" cellspacing="0">
  <tr>
    <td width="646" valign="top" scope="row"><p class="style63"><strong>Erythropoiesis</strong> <strong>:</strong> Grossly hyperactive and  megaloblastic with features of dyserythropoiesis. Nucleus is open, fine and  lacy.<br />
              <strong>Megakaryopoiesis</strong> <strong>:</strong>Reduced<br />
    </p>
        <p class="style56"><strong>Comment:&nbsp;Features are  suggestive of megaloblastic anaemia .&nbsp; </strong><strong>&nbsp;</strong></p>
        <p></p></td>
    <td colspan="2">&nbsp;</td>
