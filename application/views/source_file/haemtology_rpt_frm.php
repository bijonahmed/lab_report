...
?>
  ...
  $(document).ready(function() {
		...
		var source = '<?php echo base_url();?>data_record/print_preview_haematology'; 								//Refer to any page on your server, external pages are not valid e.g. http://www.google.co.uk
...
<script>
 $(document).ready(function() {
$(".btnPrint").printPage({
url: "<?php echo base_url(); ?>data_record/print_preview_haematology.html",
attr: "href",
...
<button class="btn btn-primary" data-toggle="modal" data-target="#search"><span class="glyphicon glyphicon-search"></span>&nbsp;Search</button>       
  ...
  <form action="<?php echo base_url();?>data_record/save_haematology_info.html" method="post">
 ...
 <div class="col-xs-2">
  ...
  <div class="col-xs-2">
      <input type="text" name="rc" class="form-control" placeholder="RC">
         ...
         <div class="row">
  <div class="col-xs-2">
    <input type="text" name="neutrophils" class="form-control" placeholder="NEUTROPHIL">
  </div>
  <div class="col-xs-2">
...
<div class="col-xs-2">
    <input type="text" name="eosinophils" class="form-control" placeholder="EOSINOPHIL">
  </div>
 <div class="col-xs-2">
    <input type="text" name="basophil" class="form-control" placeholder="BASOPHIL">
  </div>
           <br><br><br>
              <div class="col-xs-2">
    ...
    <input type="text" name="para_three_rpt" class="form-control" placeholder="RESULT">
                       ...
                       <div class="col-xs-2">
    <input type="text" name="parameter_four" class="form-control" placeholder="BLANK">
  </div>
              <div class="col-xs-2">
    <input type="text" name="para_four_rpt" class="form-control" placeholder="RESULT">
  </div>
                       <div class="col-xs-2">
...
<div class="col-xs-2">
 ...
 <div class="col-xs-2">
    <input type="text" name="rdw" class="form-control" placeholder="RDW">
       ...
       <div class="row">
  <div class="col-xs-2">
    <input type="text" name="bt_min" class="form-control" placeholder="BT MIN">
  </div>
  <div class="col-xs-2">
    <input type="text" name="bt_sec" class="form-control" placeholder="BT SEC.">
  </div>
  <div class="col-xs-2">
    <input type="text" name="ct_min" class="form-control" placeholder="CT MIN.">
  </div>
<div class="col-xs-2">
    <input type="text" name="ct_sec" class="form-control" placeholder="CT SEC.">
  </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
     ...
     <div class="modal-body">
                <div class="form-group has-success">
                    <br><br>
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-hover tableradius" id="haematology_rpt">
                        ...
                        <tbody>
                            ...
                            foreach ($view_data_haematology as $data) {
                                ...
                                <tr class="">
                                    ...
                                    <td>
                                        <a class="link" data-toggle="tooltip" data-placement="left" title="EDIT HAEMATOLOGY REPORT "href="<?php echo base_url(); ?>data_record/edit_haematology_rpt/<?php echo $data->haematology_id; ?>" onClick="return save();" style="text-decoration:none"><span class="glyphicon glyphicon-edit"></span> Edit</a>
                                        <?php
                                        /*
