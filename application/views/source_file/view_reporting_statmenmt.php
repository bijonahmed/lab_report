...
message:"Your document is being created"
 ...
 <div align="right">
    ...
    <div id="printablediv">
    <font color="red"> <center><h3><?php echo $this->session->userdata('date_from'); ?> From <?php echo $this->session->userdata('date_to'); ?> <br><?php echo $this->session->userdata('value'); ?> : <?php echo count($information); ?></h3></center></font>
