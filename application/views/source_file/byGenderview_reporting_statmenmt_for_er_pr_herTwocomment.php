...
message:"Your document is being created"
    ...
    <div class="container">
 <div align="right">
      <button type="button" class="btn btn-success" onclick="tableToExcel('er_only_search', 'ER PR HER-2 Gender & Date Range')"><i class="icon-print"></i> <span class="glyphicon glyphicon-export"></span> Excel Output</button>
    ...
    <div id="printablediv">
        <font color="red"> <center><h3>ER PR HER-2 Gender Searching<br> <?php echo $this->session->userdata('date_from'); ?> From <?php echo $this->session->userdata('date_to'); ?> <br><?php echo $this->session->userdata('value'); ?> : <?php echo count($information); ?></h3></center></font>
