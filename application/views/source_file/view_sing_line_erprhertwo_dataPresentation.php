...
<link href="<?php echo base_url(); ?>resource/Simple-jQuery-Plugin-To-Draw-A-SVG-Pie-Chart/jquerysctipttop.css" rel="stylesheet">
      ...
      <script language="javascript" type="text/javascript">
        ...
        <div class="container">
            <div align="left">
                <center>    <h3>ER PR HER-2 Graphical Presentation and Year Change Dynamically Graph Change</h3></center>
                 <hr>
    ...
    <div class="col-md-3" style="margin-top: 20px;">
      ...
      <div class="panel-heading">
        <h3 class="panel-title">ER PR HER-2 [Total Patient] </h3>
      </div>
      <div class="panel-body">
          <strong> <font color="red"> Male  : <?php echo $er_per_hertwo_data_male;?></font></strong>,
          <strong> <font color="blue">  Female : <?php echo $er_per_hertwo_data_female;?></font></strong><br>
          <strong>  Total :  <?php echo $total_patient_count;?></strong>
      </div>
    </div>
        ...
        <ul id="source">
		<li class="pieChart" value="<?php echo $er_per_hertwo_data_male;?>"><strong><font color="red">Red: - Male</font></strong></li>
		<li class="pieChart" value="<?php echo $er_per_hertwo_data_female;?>"><strong><font color="blue">Blue: -Female</font></strong></li>
