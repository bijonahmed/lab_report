...
<html lang="en">
    ...
    <div class="container">
        <div align="right">
               <button type="button" class="btn btn-success" onclick="tableToExcel('er_only_search', 'ER Date Range')"><i class="icon-print"></i> <span class="glyphicon glyphicon-export"></span> Excel Output</button>
    ...
    <div id="printablediv">
        <font color="red"> <center><h4>ER Comment<br> <?php echo $this->session->userdata('date_from'); ?> From <?php echo $this->session->userdata('date_to'); ?><br> Total  <?php echo $this->session->userdata('value'); ?> Records Found : <?php echo count($information); ?></h4></center></font>
