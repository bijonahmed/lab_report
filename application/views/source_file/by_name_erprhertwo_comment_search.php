    ...
    <head>
        ...
        <script>
            $(document).ready(function () {
                $('#erprhertwo').DataTable({
                    // "jQueryUI": true,
                    "processing": true,
                    "serverSide": true,
                    "ajax": {
                        "url": "<?php echo base_url(); ?>welcome/by_name_call_all_er_comment.html",
                        "type": "POST"
                    },
                    "columns": [
                        // {"data": "her_two_id"},
...
<br><br>
    ...
    <div class="container">
        <div class="form-group has-success">
            <h4 class="search">Search ER PR HER-2 Particular Information</h4>
            <hr>
            <table id="erprhertwo" border="1" cellpadding="2" cellspacing="1" width="100%" class="mytable display" style="background-color: yellowgreen; border-color: greenyellow;">
