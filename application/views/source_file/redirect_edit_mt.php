...
<html lang="en" ng-app="">
    <head>
        ...
        <script>
            $(function () {
<?php
foreach ($SearchMTID as $row):
    $SearchMTID[] = $row->test_id;
endforeach;

echo "var javascript_array =" . json_encode($SearchMTID);
?>
...
<br>
  ...
  <h3 class="fontcolor">{{test_id}}</h3>
                        <form name="employee" method="post" action="<?php echo base_url(); ?>welcome/SearchMtNameInfo.html">
...
<td><a class="red-tooltip link" data-toggle="tooltip" data-placement="bottom" 
       ...
       href="<?php echo redirect("data_record/edit_mt_rpt/$data->mt_id"); ?>" onClick="return sure_();" style="text-decoration:none"><div class="glyphicon glyphicon-edit"></div>&nbsp;EDIT</a></td>
