    ...
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseFive">
            <span class="glyphicon glyphicon-search"></span> PR Comment Conditional Searching....
        </a>
      </h4>
    </div>
      ...
      <div class="panel-body">
          ...
          <form name="patient_revisit" method="post" action="<?php echo base_url();?>welcome/pr_date_range_conditional_searching.html" target="_blank">
            ...
            <div class="row">
                ...
                <div class="col-xs-2"></div>
                <div class="col-xs-2">
                            <input type="text" name="starting_date" id="starting_date_pr" class="form-control" placeholder="Starting Date" required="1">
                        </div>
                <div class="col-xs-2">
                    <input type="text" name="ending_date" id="endining_date_pr" class="form-control" placeholder="Ending Date" required="1">
                        </div>
                <div class="col-xs-2">
...
Search</button>
    ...
    $('#starting_date_pr').datepicker()
</script>
<script type="text/javascript">
    $('#endining_date_pr').datepicker()
</script>
