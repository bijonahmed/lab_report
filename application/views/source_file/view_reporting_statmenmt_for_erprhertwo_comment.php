...
message:"Your document is being created"
 ...
 <div align="right">
    ...
    <div id="printablediv">
        <font color="red"> <center><h4>HER-2 Comment<br> <?php echo $this->session->userdata('date_from'); ?> From <?php echo $this->session->userdata('date_to'); ?> <br><?php echo $this->session->userdata('value'); ?>  Records Found :<?php echo count($information); ?></h4></center></font>
    ...
    overflow: scroll;">
        ...
        <div class="form-group has-feedback">
            ...
            <table cellpadding="0" cellspacing="0" border="1" class="table table-hover tableradius" id="" style="">
