...
message:"Your document is being created"
    ...
    <div class="container">
 <div align="right">
       <button type="button" class="btn btn-success" onclick="tableToExcel('er_only_search', 'PR Date Range')"><i class="icon-print"></i> <span class="glyphicon glyphicon-export"></span> Excel Output</button>
    ...
    <div id="printablediv">
        <font color="red"> <center><h3>PR Comment<br> <?php echo $this->session->userdata('date_from'); ?> From <?php echo $this->session->userdata('date_to'); ?> <br><?php echo $this->session->userdata('value'); ?> : <?php echo count($information); ?></h3></center></font>
    ...
    overflow: scroll;">
        ...
        <div class="form-group has-feedback">
            ...
            <table cellpadding="0" cellspacing="0" border="3" class="table table-hover tableradius" id="er_only_search" style="">
                ...
                <thead>
                    <tr class="headColor">
                        <th width="270">Test ID</th>
                        <th width="160">SL NO</th>
                        <th width="950">Patient Name</th>
                        <th width="100">Age</th>
