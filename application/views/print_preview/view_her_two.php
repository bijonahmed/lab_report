...
<strong><i class="icon-user icon-large"></i>&nbsp;Special ER PR HER-2 Search and Update Report</strong>                            </div>
<thead>
<tr>
<th>SL No</th>
<th>Test ID</th>
...
<a class="btn btn-danger" href="<?php echo base_url();?>pathology_reporting_controller/delete_her_two/<?php echo $UiInfo->her_two_id;?>" onClick="return delete_her_two();"> <i class="icon-trash icon-white"></i>&nbsp;Delete</a>
