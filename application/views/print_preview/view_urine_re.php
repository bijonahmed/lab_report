...
<strong><i class="icon-user icon-large"></i>&nbsp;Urine Report Search and update</strong>                            </div>
<thead>
<tr>
<th>Test ID</th>
<th>Patient Name</th>
...
foreach($urine_re_info as $UiInfo) {
?>
<tr >
...
<td>
<a class="btn btn-primary" href="<?php echo base_url();?>pathology_reporting_controller/update_urine_re_form/<?php echo $UiInfo->urine_id;?>" onClick="return update_urine_re();"><i class="icon-edit icon-white"></i>&nbsp;Edit</a>
<a class="btn btn-danger" href="<?php echo base_url();?>pathology_reporting_controller/delete_urine_re/<?php echo $UiInfo->urine_id;?>" onClick="return delete_haematology();"><i class="icon-trash icon-white"></i>&nbsp;Delete</a>
</td>
</td>
</tr>
<?php }?>
