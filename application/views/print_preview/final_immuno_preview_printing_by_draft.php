...
-->
 ...
 <hr>
 <table border="0" align="center" cellspacing="0" height="250">
   <tr>
     <td width="720" height="20" valign="top"><p> <span class="style39"><?php echo $this->session->userdata('note')?></span><br />
     </p></td>
   </tr>
   <tr>
     <td height="21">&nbsp;</td>
   ...
   <tr>
     <td height="20"><span class="style9"><?php echo $this->session->userdata('reporting_board')?></span></td>
   </tr>
   <tr>
     <td height="21">&nbsp;</td>
   </tr>
   ...
   <tr>
     <td height="21" valign="top" class="style7"><div align="center"><br>
