...
<html>
    <style type="text/css">
        ...
        .style61 {font-size: 13px; color: #000000; }
        -->
    </style>
    ...
    <div style="height:540px;">
        <table width="902" border="0" align="center" cellspacing="0">
            ...
            if ($this->session->userdata('her_two_score')) {
                ...
                <?php
                $kisixtyseven = $this->session->userdata('kisixtyseven');
                if ($kisixtyseven) {
                    ?>

                    <tr>
                        <td colspan="3" valign="top" class="style49"><strong>Ki67&nbsp; &nbsp;  : </strong><?php echo $this->session->userdata('kisixtyseven') ?></td>
                    </tr>
                    <?php
                }
                ?>
                ...
                <tr>
                    <td colspan="3" valign="top" class="style49"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&nbsp;</strong></strong> </td>
                </tr>
            ...
            if ($this->session->userdata('rpt_noet')) {
                ?>
                <tr>
                    <td colspan="3" valign="top" class="style47"><br></td>
                </tr>
                <tr>
          ...
          <tr>
            <td width="307" valign="top" scope="row"><p align="left"><span class="style6"><span class="style61">DR. KUAZI DIL AFROZ <span class="style28"><br />
                ...
                Delta Hospital Ltd. Dhaka. </span></p>
                          <p></p></td>
                      <td colspan="2">&nbsp;</td>
                      <td width="295" valign="top"><span class="style53"><span class="style27">PROF. DR. SYED SALAHUDDIN AHMED </span><br />
                        <span class="style28">MBBS; PhD(Japan) <br />
                          WHO Fellow (Cytopathology) Tata.India<br />
                          Senior Consultant (Histopathology) <br />
                          Delta Hospital Ltd. Dhaka.</span></span></td>
          </tr>
          
      </table></td><td width="377" rowspan="2"><div align="center" class="style57"><br>
                <br>
                <br>
