...
foreach($patient_info as $UiInfo) {
?>
<tr>
...
<td>
    <a class="btn btn-primary" href="<?php echo base_url();?>pathology_reporting_controller/update_cytospine_form/<?php echo $UiInfo->her_two_id;?>" onClick="return update_cytospine_rpt();"><i class="icon-edit icon-white"></i>&nbsp;Edit</a>
