...
-->
 ...
 <table width="780" border="0" align="center" cellspacing="0">
   <tr>
     <td colspan="3"><p class="style42"> <span class="style49"><?php echo $this->session->userdata('note')?></span><br />
     </p></td>
   </tr>
   <tr>
     <td colspan="3"><span class="style52"><strong>ER&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; <span class="style47">&nbsp;</span>:</strong> <?php echo $this->session->userdata('er_rpt')?></span></td>
   </tr>
   <tr>
     <td colspan="3">&nbsp;</td>
   </tr>
   <tr>
     <td colspan="3"><span class="style52">Quick Score<strong>&nbsp;</strong>:&nbsp;<strong>&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;=&nbsp;&nbsp;&nbsp; &nbsp;<span class="style47">&nbsp;</span>&nbsp; &nbsp;<span class="style47">&nbsp;</span>&nbsp;</strong><?php echo $this->session->userdata('er_score')?><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>&quot;O&quot; </span></td>
   </tr>
   <tr>
     <td colspan="3">&nbsp;</td>
   </tr>
   <tr>
     <td colspan="3" class="style52"><strong>PR&nbsp; &nbsp; &nbsp;     &nbsp;   &nbsp; : </strong><?php echo $this->session->userdata('pr_rpt')?> </td>
   </tr>
   <tr>
     <td colspan="3">&nbsp;</td>
   </tr>
   <tr>
     <td colspan="3" class="style52">Quick Score<strong>&nbsp;</strong>:<strong>&nbsp;&nbsp;  &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;=&nbsp; &nbsp;<span class="style47">&nbsp;</span>&nbsp; &nbsp;<span class="style47">&nbsp;</span>&nbsp;&nbsp;</strong><?php echo $this->session->userdata('er_score')?><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>&quot;O&quot; </td>
   </tr>
   <tr>
     <td colspan="3">&nbsp;</td>
   </tr>
   <tr>
     <td colspan="3"><span class="style28"><span class="style38"><span class="style45"><strong>HER-2  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</strong><br>
   ...
   <tr>
     <td colspan="3"><span class="style28"><strong>Summary of result:</strong></span></td>
   </tr>
   <tr>
     <td colspan="3" class="style34">   <span class="style45">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ER     :Negative/Positive<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; PR     :Negative/Positive<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; HER-2:Negative/Positive/Borderline</span></td>
   </tr>

   <tr>
     <td colspan="2" rowspan=" " class="style7">&nbsp;</td>
     <td width="282" rowspan="2"><p align="left" class="style26"><span class="style27"><br>
       <br>
       DR. SYED SALAHUDDIN AHMED </span><br />
...
Delta Hospital Ltd. Dhaka.</span></p>
   ...
   <tr>
     <td width="252" height="21" class="style7"><span class="style6"><span class="style26">DR. KUAZI DIL AFROZ <span class="style12"><br />
...
Delta Hospital Ltd. Dhaka. </span></span></td>
   ...
   <tr>
     <td colspan="3" class="style7"><div align="center" class="style38">&nbsp;Printing Date &amp; Time : <?php
$today=date("d-m-Y");
