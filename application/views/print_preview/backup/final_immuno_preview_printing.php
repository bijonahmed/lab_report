...
.style40 {font-size: 11px; color: #FFFFFF; }
.style41 {font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #FFFFFF; }
-->
 </style>
 ...
 <table width="698" height="" border="0" align="center" cellspacing="0">
   <tr>
     <td width="707" height="20" valign="top"><p><strong> </strong><strong><?php echo $this->session->userdata('note')?></strong><br />
     </p></td>
   </tr>
   <tr>
     <td height="20" valign="top"><span class="style9"><?php echo $this->session->userdata('reporting_board')?></span></td>
   </tr>
   <tr>
   ...
   <table border="0" align="center" cellspacing="0" height="107">

     <tr>
       <td width="190" height="86" rowspan=" " valign="top" class="style7"><div align="left"><span class="style6"><span class="style40">DR. KUAZI DIL AFROZ <span class="style12"><br />
           </span></span></span><span class="style41"><span class="style26">MBBS; Phd(Japan)<br />
     ...
     <tr>
       <td height="21" colspan="3" valign="top" class="style7"><div align="center" class="style38"><span class="style9">&nbsp;Printing Date &amp; Time :
       <?php
$today=date("d-m-Y");
