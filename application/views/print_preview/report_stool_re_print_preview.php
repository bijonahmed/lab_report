...
-->
 ...
 <table width="859" border="0" align="center" cellspacing="0" bordercolor="#000000">
   <tr>
     <td width="154"><span class="style47">Test ID </span></td>
     <td width="8"><span class="style47"><strong>:</strong></span></td>
     <td width="225"><span class="style47"><strong><?php echo $this->session->userdata('test_id')?></strong></span></td>
   ...
   <tr>
     ...
     <td><span class="style47"><strong>:</strong></span></td>
     <td colspan="3"><span class="style47"><?php echo $this->session->userdata('material')?></span></td>
   </tr>
 </table>
 <hr>
 ...
 <table width="863" border="1" align="center" cellpadding="1" cellspacing="0">
   ...
   <tr>
	 ...
	 <?php echo $this->session->userdata('quantity')?></div></td>
