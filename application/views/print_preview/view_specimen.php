...
$(".btnPrint").printPage({
url: "<?php echo base_url(); ?>pathology_reporting_controller/print_vew_speciment_name.html",
attr: "href",
...
<strong><i class="icon-user icon-large"></i>&nbsp;All Specimen List</strong> <button type="button" class="btn btnPrint" >Print All Specimen Name</button> </div>
...
<td>
<a class="btn btn-primary" href="<?php echo base_url();?>pathology_reporting_controller/update_specimen_form/<?php echo $UiInfo->speciment_id;?>" onClick="return update_specimen();"><i class="icon-edit icon-white"></i>&nbsp;Edit</a>
...
<?php
/*
 <a class="btn btn-danger" href="<?php echo base_url();?>pathology_reporting_controller/delete_specimen_rpt/<?php echo $UiInfo->speciment_id;?>" onClick="return delete_specimen();"><i class="icon-trash icon-white"></i>&nbsp;Delete</a>
 */
