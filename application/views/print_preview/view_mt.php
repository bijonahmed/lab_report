...
<strong><i class="icon-user icon-large"></i>&nbsp;MT (MANTOUX TEST) Report Search and Update</strong>                            </div>
<thead>
<tr>
...
foreach($mt_testInformation as $UiInfo) {
?>
<tr>
...
<td>
    <a class="btn btn-primary" href="<?php echo base_url();?>pathology_reporting_controller/update_mt_form/<?php echo $UiInfo->mt_id;?>" onclick="return update_viewInfo();"><i class="icon-edit icon-white"></i>&nbsp;Edit</a>
