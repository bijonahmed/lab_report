...
<table width="" border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="23" colspan="9" valign="top"><span class="style10 style22 style24">
            PT. ID: <strong><?php echo $this->session->userdata('patient_id')?></strong></span>  Manual PT. ID: <strong><?php echo $this->session->userdata('manual_pid')?></strong>, Name :<strong><?php echo $this->session->userdata('patient_name')?></strong> , Age : <strong><?php  echo $this->session->userdata('age')?></strong>, Sex:<strong> <?php echo $this->session->userdata('sex')?></strong> , 
            Date: <strong><?php echo $this->session->userdata('current_date') ?></strong>, Visit NO:<strong><?php echo $this->session->userdata('visiting_no') ?></strong>
    </span></td>date
  </tr>
  <tr>
